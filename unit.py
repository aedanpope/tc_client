...
# To insert +1 on each line:
# - Select multiple lines (e.g.
# - create multiple cursors
#   a) multiple lines selected, then Ctrl+Shift+L
#   b) ctrl-F then "Find all"
# - Open program panel with Ctrl+Shift+P
# - Select "Text Pastry: from 1 to X"
